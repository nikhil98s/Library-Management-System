...
ALTER TABLE `book_issue_log`
  ADD CONSTRAINT `pk_fk` FOREIGN KEY (`book_isbn`) REFERENCES `book` (`isbn`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
...
ALTER TABLE `member`
  ADD CONSTRAINT `pk_fk_member` FOREIGN KEY (`username`) REFERENCES `pending_registrations` (`username`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
